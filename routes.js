...
router.put("/increment-quantity/:id", incrementQuantity)//put --- Used for updating or replacing an existing resource. Multiple identical PUT requests will produce the same result (idempotent).
